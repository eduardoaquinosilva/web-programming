                            ...
                            <div class="row g-3">
                                <div class="col-sm-12">
                                    <div class="form-floating">
                                        <input type="text" class="form-control border-0 bg-light" id="gname" placeholder="Nome" name="ntena" required>
                                        <label for="gname">Nome</label>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-floating">
                                        <input type="text" class="form-control border-0 bg-light" id="gname" placeholder="Profissão" name="ntepr" required>
                                        <label for="gname">Profissão</label>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-floating">
                                        <input type="text" class="form-control border-0 bg-light" id="gname" placeholder="URL" name="nteurl" required>
                                        <label for="gname">URL da Imagem</label>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-floating">
                                        <textarea class="form-control border-0 bg-light" placeholder="Leave a message here" id="message2" style="height: 150px" name="ncom"></textarea required>
                                        <label for="message2">Comentário</label>
                                    </div>
                                </div>
