                ...
                <div class="row g-5">
                    <div class="col-lg-12 wow fadeInUp" data-wow-delay="0.5s">
                        ...
                        <?php
                            ...
                            try {
                                $sql = $pdo->query("SELECT * FROM contact");
                        ...
                        ?>
                                        <div class="card text-center">
                                            <div class="card-header" style="background-color: #F3BD00;">
                                                <?php print $contact->assunto; ?>
                                            </div>
                                            <div class="card-body">
                                                <h5 class="card-title"> <?php print $contact->nome; ?> </h5>
                                                <h6 class="card-title"> <?php print $contact->email; ?> </h6>
                                                <p class="card-text"> <?php print $contact->menssagem; ?> </p>
                                            </div>
                                            <div class="card-footer text-muted" style="background-color: #F3BD00;">
                                                <?php print $contact->data_hora; ?>
                                            </div>
                                        </div><br>
                        <?php
                                    }
