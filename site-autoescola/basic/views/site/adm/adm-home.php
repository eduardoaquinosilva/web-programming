...
<html lang="en">
    <head>
        ...
        <title>Área do Administrador - Drivin</title>
        ...
        <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto p-4 p-lg-0">
                    <a href="adm-home.php" class="nav-item nav-link active">Home</a>
            ...
            <div class="container">
                <div class="row g-5">
                    <div class="col-lg-12 wow fadeInUp" data-wow-delay="0.5s">
                        <h1 class="display-6 mb-4">HOME</h1>
                        <form action="back-home.php" method="POST">
                            <div class="row g-3">
                                <div class="col-sm-6">
                                    <div class="form-floating">
                                        <input type="text" class="form-control border-0 bg-light" id="gname" placeholder="Título Banner 1" name="ntiba1">
                                        <label for="gname">Título Banner 1</label>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-floating">
                                        <input type="text" class="form-control border-0 bg-light" id="gmail" placeholder="Título Banner 2" name="ntiba2">
                                        <label for="gmail">Título Banner 2</label>
                                    </div>
                                </div>
                                <div class="col-12">
