...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Our Team - Drivin - Driving School Website Template</title>
    ...
    <body>
        ...
        <?php
			...
			$name1 = $query->nome1;
			$profession1 = $query->cargo1;
			$url_img1 = $query->url_img1;
			$url_facebook1 = $query->url_facebook1;
			$url_twitter1 = $query->url_twitter1;
			$url_instagram1 = $query->url_instagram1;
			$name2 = $query->nome2;
			$profession2 = $query->cargo2;
			$url_img2 = $query->url_img2;
			$url_facebook2 = $query->url_facebook2;
			$url_twitter2 = $query->url_twitter2;
			$url_instagram2 = $query->url_instagram2;
			$name3 = $query->nome3;
			$profession3 = $query->cargo3;
			$url_img3 = $query->url_img3;
			$url_facebook3 = $query->url_facebook3;
			$url_twitter3 = $query->url_twitter3;
			$url_instagram3 = $query->url_instagram3;
			$name4 = $query->nome4;
			$profession4 = $query->cargo4;
			$url_img4 = $query->url_img4;
			$url_facebook4 = $query->url_facebook4;
			$url_twitter4 = $query->url_twitter4;
			$url_instagram4 = $query->url_instagram4;
        ?>
