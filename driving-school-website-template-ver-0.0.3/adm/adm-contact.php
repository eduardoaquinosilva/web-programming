...
<html lang="en">
    <head>
        ...
        <title>Contact - Área do Administrador - Drivin</title>
        ...
        <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto p-4 p-lg-0">
                    ...
                    <a href="adm-contact.php" class="nav-item nav-link active">Contact</a>
                ...
                <div class="row g-5">
                    <div class="col-lg-12 wow fadeInUp" data-wow-delay="0.5s">
                        ...
                        <?php
                            ...
                            if (!empty($_SESSION['contactsList'])) {
                                $contact = $_SESSION['contactsList'];
                                foreach ($contact as $message) {
                        ?>
                                    <div class="card text-center">
                                        <div class="card-header" style="background-color: #F3BD00;">
                                            <?php print $message['contactSubject']; ?>
                                        </div>
                                        <div class="card-body">
                                            <h5 class="card-title"> <?php print $message['contactName']; ?> </h5>
                                            <h6 class="card-title"> <?php print $message['contactEmail']; ?> </h6>
                                            <p class="card-text"> <?php print $message['contactMessage']; ?> </p>
                                            <!--<a href="#" class="btn btn-primary">Go somewhere</a>-->
                                        </div>
                                        <div class="card-footer text-muted" style="background-color: #F3BD00;">
                                            <?php print $message['contactDate']; ?>
                                        </div>
                                    </div><br>
                        <?php
                                }
                            } else {
                                print "There are no messages registered.";
                            }
                        ?>
