                ...
                <div class="row g-5">
                    <div class="col-lg-12 wow fadeInUp" data-wow-delay="0.5s">
                        ...
                        <?php
                            ...
                            if (!empty($_SESSION['appointmentsList'])) {
                                $appointments = $_SESSION['appointmentsList'];
                                foreach($appointments as $message) {
                        ?>
                                    <div class="card text-center">
                                        <div class="card-header" style="background-color: #F3BD00;">
                                            <?php print ucfirst(strtolower($message['appointmentCourseType'])) . ' | ' . ucfirst(strtolower($message['appointmentCarType'])); ?>
                                        </div>
                                        <div class="card-body">
                                            <h5 class="card-title"> <?php print $message['appointmentName']; ?> </h5>
                                            <h6 class="card-title"> <?php print $message['appointmentEmail']; ?> </h6>
                                            <p class="card-text"> <?php print $message['appointmentMessage']; ?> </p>
                                            <!--<a href="#" class="btn btn-primary">Go somewhere</a>-->
                                        </div>
                                        <div class="card-footer text-muted" style="background-color: #F3BD00;">
                                            <?php print $message['appointmentDate']; ?>
                                        </div>
                                    </div><br>
                        <?php
                                }
