                    ...
                    <div class="col-lg-12 wow fadeInUp" data-wow-delay="0.5s">
                        ...
                        <form action="back-team.php" method="POST">
                            <div class="row g-3">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-floating">
                                        <input type="url" class="form-control border-0 bg-light" id="gname" placeholder="URL Imagem 1" name="nuim1">
                                        <label for="gname">URL Imagem 1</label>
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-floating">
                                        <input type="url" class="form-control border-0 bg-light" id="gname" placeholder="URL Facebook 1" name="nuf1">
                                        <label for="gname">URL Facebook 1</label>
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-floating">
                                        <input type="url" class="form-control border-0 bg-light" id="gname" placeholder="URL Twitter 1" name="nut1">
                                        <label for="gname">URL Twitter 1</label>
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-floating">
                                        <input type="url" class="form-control border-0 bg-light" id="gname" placeholder="URL Instagram 1" name="nuin1">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-floating">
                                        <input type="url" class="form-control border-0 bg-light" id="gname" placeholder="URL Imagem 2" name="nuim2">
                                        <label for="gname">URL Imagem 2</label>
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-floating">
                                        <input type="url" class="form-control border-0 bg-light" id="gname" placeholder="URL Facebook 2" name="nuf2">
                                        <label for="gname">URL Facebook 2</label>
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-floating">
                                        <input type="url" class="form-control border-0 bg-light" id="gname" placeholder="URL Twitter 2" name="nut2">
                                        <label for="gname">URL Twitter 2</label>
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-floating">
                                        <input type="url" class="form-control border-0 bg-light" id="gname" placeholder="URL Instagram 2" name="nuin2">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-floating">
                                        <input type="url" class="form-control border-0 bg-light" id="gname" placeholder="URL Imagem 3" name="nuim3">
                                        <label for="gname">URL Imagem 3</label>
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-floating">
                                        <input type="url" class="form-control border-0 bg-light" id="gname" placeholder="URL Facebook 3" name="nuf3">
                                        <label for="gname">URL Facebook 3</label>
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-floating">
                                        <input type="url" class="form-control border-0 bg-light" id="gname" placeholder="URL Twitter 3" name="nut3">
                                        <label for="gname">URL Twitter 3</label>
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-floating">
                                        <input type="url" class="form-control border-0 bg-light" id="gname" placeholder="URL Instagram 3" name="nuin3">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-floating">
                                        <input type="url" class="form-control border-0 bg-light" id="gname" placeholder="URL Imagem 4" name="nuim4">
                                        <label for="gname">URL Imagem 4</label>
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-floating">
                                        <input type="url" class="form-control border-0 bg-light" id="gname" placeholder="URL Facebook 4" name="nuf4">
                                        <label for="gname">URL Facebook 4</label>
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-floating">
                                        <input type="url" class="form-control border-0 bg-light" id="gname" placeholder="URL Twitter 4" name="nut4">
                                        <label for="gname">URL Twitter 4</label>
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-floating">
                                        <input type="url" class="form-control border-0 bg-light" id="gname" placeholder="URL Instagram 4" name="nuin4">
