...
class AdminsController extends Controller
{
     ...
     * @param int $idadmins Idadmins
     * @return string
     * @throws NotFoundHttpException if the model cannot be found
     */
    public function actionView($idadmins)
    {
        return $this->render('view', [
            'model' => $this->findModel($idadmins),
        ]);
    }
    ...
    public function actionCreate()
    {
        ...
        if ($this->request->isPost) {
            if ($model->load($this->request->post()) && $model->save()) {
                return $this->redirect(['view', 'idadmins' => $model->idadmins]);
            }
        } else {
     ...
     * @throws NotFoundHttpException if the model cannot be found
     */
    public function actionUpdate($idadmins)
    {
        $model = $this->findModel($idadmins);
     ...
     * @throws NotFoundHttpException if the model cannot be found
     */
    public function actionDelete($idadmins)
    {
        $this->findModel($idadmins)->delete();
     ...
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($idadmins)
    {
        if (($model = Admins::findOne(['idadmins' => $idadmins])) !== null) {
            return $model;
        }
