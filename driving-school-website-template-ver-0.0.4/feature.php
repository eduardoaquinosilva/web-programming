...
<html lang="en">
    ...
    <body>
        ...
        <?php
            ...
            try {
                $sql = $pdo->query("SELECT * FROM features WHERE idfeatures = 1");
                $result = $sql->fetchAll(PDO::FETCH_OBJ);

                foreach($result as $feature) {
                    $title = $feature->titulo;
                    $subtitle = $feature->subtitulo;
                    $description1 = $feature->desc1;
                    $description2 = $feature->desc2;
                    $description3 = $feature->desc3;
                    $description4 = $feature->desc4;
                }
